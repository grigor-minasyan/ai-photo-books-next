...
export function SignupForm({ ...props }: React.ComponentProps<typeof Card>) {
  ...
  async function onSignUp(formData: FormData) {
    ...
    setSuccessMessage("Account created. Enter the OTP sent to your email to verify.")
  }
          ...
          <div className="space-y-4">
            <FieldGroup>
              <Field>
                ...
                <FieldDescription>Enter the OTP sent to {email}.</FieldDescription>
              ...
              <Field>
                ...
                <Button type="button" variant="outline" disabled={isPending} onClick={resendOtp}>
                  Resend code
                </Button>
              </Field>
            </FieldGroup>
