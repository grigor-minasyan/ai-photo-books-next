    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      <section className="rounded-2xl border bg-linear-to-br from-slate-50 to-white p-8 sm:p-12">
        <div className="max-w-2xl space-y-5">
          <p className="text-sm font-medium text-primary">Personalized Storybooks</p>
          <h1 className="text-3xl font-bold tracking-tight sm:text-5xl">
            Turn your child into the hero of their own AI-generated book
          </h1>
          <p className="text-base text-muted-foreground sm:text-lg">
            Upload your child&apos;s portrait, generate a matching story character, and preview magical books
            before printing.
          </p>
      ...
      <section id="books" className="pt-14">
        <div className="mb-6 flex items-end justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Browse source books available for personalization.</p>
          </div>
        </div>
